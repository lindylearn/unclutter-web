...
export default function ExampleLayout({
    ...
    return (
        <div
            className={
                "w-5/6 flex flex-col md:flex-row gap-3 md:gap-10 justify-start " +
            ...
            ref={ref}
        >
            <div className="w-full md:max-w-lg flex-shrink-0 relative rounded-xl overflow-hidden shadow-xl desktop:hover:cursor-pointer desktop:hover:shadow-2xl">
                <ExampleLayoutContext.Provider value={{ inView }}>
                    {children}
                </ExampleLayoutContext.Provider>
            </div>

            <div className="flex-shrink-0 flex flex-col md:mt-5 gap-1 md:gap-3 items-start">
